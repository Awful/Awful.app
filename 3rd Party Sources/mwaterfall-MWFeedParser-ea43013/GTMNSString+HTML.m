...
- (NSString *)gtm_stringByEscapingForAsciiHTML {
	return [self gtm_stringByEscapingHTMLUsingTable:gNone
											 ofSize:sizeof(gAsciiHTMLEscapeMap) 
									escapingUnicode:YES];
} // gtm_stringByEscapingAsciiHTML

- (NSString *)gtm_stringByEscapingUnicode {
    return [self gtm_stringByEscapingHTMLUsingTable:gNone ofSize:sizeof(gNone) escapingUnicode:YES];
} // gtm_stringByEscapingUnicode
