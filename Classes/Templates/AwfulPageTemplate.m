...
-(NSString *)constructHTMLFromPageDataController : (AwfulPageDataController *)dataController
{
    ...
    self.mainHTML = [NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"phone-template" ofType:@"html"] encoding:NSUTF8StringEncoding error:nil];
