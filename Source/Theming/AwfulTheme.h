...
/// Stores colors, fonts, and other easily-customizable design parameters.
...
/// Returns YES if the theme is forum-specific, NO if it applies to all forums. The default is NO.
