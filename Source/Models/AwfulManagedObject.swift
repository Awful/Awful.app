...
public class AwfulManagedObject: NSManagedObject {
    ...
    class func insertIntoManagedObjectContext(context: NSManagedObjectContext) -> Self {
...
extension AwfulManagedObject {
    ...
    */
    class func objectsForKeys(objectKeys: [AwfulObjectKey], inManagedObjectContext context: NSManagedObjectContext) -> [AwfulManagedObject] {
        precondition(!objectKeys.isEmpty)
