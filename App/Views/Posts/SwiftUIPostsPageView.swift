...
struct SwiftUIPostsPageView: View {
    ...
    var body: some View {
        mainContentView
            ...
            .sheet(isPresented: $showingImageViewer) {
                if let imageURL = presentedImageURL {
                    SwiftUIImageViewer(imageURL: imageURL)
                        .environment(\.theme, theme)
                }
            }
            .onChange(of: showingImageViewer) { isShowing in
            ...
            .onChange(of: presentedImageURL) { newURL in
    ...
    private var mainRenderView: some View {
        SwiftUIRenderView(
            ...
            presentedImageURL: $presentedImageURL,
