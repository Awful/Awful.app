...
final class SettingsThemePickerViewController: TableViewController {
    ...
    init(defaultMode mode: Theme.Mode) {
        ...
        switch mode {
        case .dark:
            settingsKey = UserDefaults.SettingsKeys.defaultDarkTheme
        case .light:
            settingsKey = UserDefaults.SettingsKeys.defaultLightTheme
        }
    ...
    override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        let maxSize = CGSize(width: tableView.safeAreaLayoutGuide.layoutFrame.width - 40, height: .greatestFiniteMagnitude)
